					...
					<div class="yui-gf">
					 ...
					 <?php
						...
						try {
						   ...
						   $jobsquery = $connection->query("SELECT employer_name, job_title, period_time, employment_start_date, employment_end_date FROM cv ORDER BY employment_end_date ASC");

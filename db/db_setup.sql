...
CREATE TABLE jobs (id int primary key auto_increment, job_title varchar(100), employer_name varchar(50), period_time varchar(50), job_description text(5000));
...
INSERT INTO jobs (employer_name, job_title, period_time, job_description) VALUES ('Telus International', 'Senior Support Representative - Decembeer 2019 - August 2020', 'April 2019 - August 2020', 'As a Senior Support Representative, I was part of a team responsible for handling tier 1 techical escalations related to issues with an online game');
INSERT INTO jobs (employer_name, job_title, period_time, job_description) VALUES ('Telus International', 'Support Representative - April 2019 -  December 2019', 'April 2019 - August 2020', 'As a Support Rep for Telus, my main responsibilities were to provide basic customer support services to the users of the client services.');
